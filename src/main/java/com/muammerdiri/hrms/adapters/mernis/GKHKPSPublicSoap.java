...
public class GKHKPSPublicSoap
{
    ...
    public GKHKPSPublicSoap(){}

    public GKHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GKHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GKHExtendedSoapSerializationEnvelope envelope= new GKHExtendedSoapSerializationEnvelope(GKHExtendedSoapSerializationEnvelope.VER11);
